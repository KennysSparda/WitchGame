class Game {
    ...
    spawnLevelEnemies() {
        ...
        this.engine.entities = this.engine.entities.filter(entity => !(entity instanceof Enemy));
        ...
        for (let i = 0; i < this.level; i++) {
            ...
            this.engine.addEntity(new Enemy(config.x, config.y, 3, enemyColor, '', this.engine, config.type));
        }
    }
